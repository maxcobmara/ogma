...
#     ])
    ...
    @visitor2=FactoryGirl.create(:visitor, name: "Visitor 1", icno: "123456789101", rank_id: @rank.id, title_id: @title.id, college_id: @college.id, corporate: true, address_book_id: @address_book.id, phoneno: "1234567891", hpno: "1234567890", email:  "visitor1@example.com", expertise: "My Expertise")
...
#     render
    ...
    assert_select "tr>td", :text => "#{@address_book.name}".to_s, :count => 2
  end
end
