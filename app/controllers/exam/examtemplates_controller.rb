class Exam::ExamtemplatesController < ApplicationController
  before_action :set_examtemplate, only: [:show, :edit, :update, :destroy]
  # GET /examtemplates
  ...
  private
    ...
    def set_examtemplate
      @examn = Examtemplate.find(params[:id])
    end

    # Never trust parameters from the scary internet, only allow the white list through.
    def examtemplate_params
      params.require(:examtemplate).permit(:quantity, :exam_id, :total_marks, :questiontype)
    end
end
