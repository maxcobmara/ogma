class StudentsController < ApplicationController
  ...
  private
    ...
    def student_params
      params.require(:student).permit(:address, :address_posbasik, :allergy, :bloodtype, :course_id, :course_remarks, :created_at, :disease, :end_training, :gender, :group_id, :icno, :id, :intake, :intake_id, :matrixno, :medication, :mrtlstatuscd, :name, :offer_letter_serial, :photo_content_type, :photo_file_name, :photo_file_size, :photo_updated_at, :physical, :race, :race2, :regdate, :remarks, :sbirthdt, :semail, :specialisation, :specilisation, :ssponsor, :sstatus, :stelno, :updated_at, :sstatus_remark,  :college_id, {:data=>[]}, kins_attributes: [:id,:_destroy, :kintype_id,  :name, :mykadno, :phone, :profession, :kinaddr], qualifications_attributes:[:id,:_destroy, :level_id, :qname, :institute], spmresults_attributes: [:id, :_destroy, :spm_subject, :grade])
    end
