...
def bahagian3
  ...
  data1 = [["", "KRITERIA (Dinilai berasaskan SKT)", "PPP", "PPK"],
           ...
           ["","Kuantiti hasil kerja seperti jumlah bilangan, kadar, kekerapan dan sebagainya berbanding dengan sasaran kuantiti 
             kerja yang ditetapkan.", "#{@staff_appraisal.e1g1q1}" , "#{@staff_appraisal.e2g1q1 if @curr_user.userable_id == @staff_appraisal.eval2_by}" ],
             ["2. ","  KUALITI HASIL KERJA", "",""],
             ["2.1. ","Dinilai dari segi kesempurnaan, teratur dan kemas.", "#{@staff_appraisal.e1g1q2}","#{@staff_appraisal.e2g1q2 if @curr_user.userable_id == @staff_appraisal.eval2_by}"],
             ["2.2."," Dinilai dari segi usaha dan inisiatif untuk mencapai kesempurnaan hasil kerja.","#{@staff_appraisal.e1g1q3 }","#{@staff_appraisal.e2g1q3 if @curr_user.userable_id == @staff_appraisal.eval2_by}"],
             ["3. ","  KETEPATAN MASA","",""],
             ["","Kebolehan menghasilkan kerja atau melaksanakan tugas dalam tempoh masa yang ditetapkan.","#{@staff_appraisal.e1g1q4}","#{@staff_appraisal.e2g1q4 if @curr_user.userable_id == @staff_appraisal.eval2_by}"],
             ["4. ","  KEBERKESANAN HASIL KERJA", "",""],
             ["","Dinilai dari segi memenuhi kehendak 'stake-holder' atau pelanggan.","#{@staff_appraisal.e1g1q5}","#{@staff_appraisal.e2g1q5 if @curr_user.userable_id == @staff_appraisal.eval2_by}"],
             ["", "Jumlah markah mengikut wajaran","#{@staff_appraisal.e1g1_total} / 50 x 50 = #{@view.number_with_precision(@staff_appraisal.e1g1_percent, precision: 2, locale: "en") }","#{@staff_appraisal.e1g2_total if @curr_user.userable_id == @staff_appraisal.eval2_by} / 50 x 50 = #{@view.number_with_precision(@staff_appraisal.e2g1_percent, precision: 2, locale: "en") if @curr_user.userable_id == @staff_appraisal.eval2_by}"]]
...
def bahagian4_4
  ...
  data1 = [["", "KRITERIA ", "PPP", "PPK"],
           ...
           ["","Mempunyai ilmu pengetahuan dan kemahiran/kepakaran dalam menghasilkan kerja meliputi kebolehan mengenalpasti, menganalisis serta menyelesaikan masalah.", "#{@staff_appraisal.e1g2q1}" , "#{@staff_appraisal.e2g2q1 if @curr_user.userable_id == @staff_appraisal.eval2_by}" ],
             ["2. ","  PELAKSANAAN DASAR, PERATURAN DAN ARAHAN PENTADBIRAN", "",""],
             ["","Kebolehan menghayati dan melaksanakan dasar, peraturan dan arahan pentadbiran berkaitan dengan bidang tugasnya.", "#{@staff_appraisal.e1g2q2}","#{@staff_appraisal.e2g2q2 if @curr_user.userable_id == @staff_appraisal.eval2_by}"]]
       ...
       data2 = [["", "KRITERIA (Dinilai berasaskan SKT)", "PPP", "PPK"],
                 ...
                 ["","Kuantiti hasil kerja seperti jumlah bilangan, kadar, kekerapan dan sebagainya berbanding dengan sasaran kuantiti kerja yang ditetapkan.","#{@staff_appraisal.e1g2q3}","#{@staff_appraisal.e2g2q3 if @curr_user.userable_id == @staff_appraisal.eval2_by}"],
                 ["", "Jumlah markah mengikut wajaran","#{@staff_appraisal.e1g2_total} / 30 x 25 = #{@view.number_with_precision(@staff_appraisal.e1g2_percent, precision:2, locale: "en")}",
                   "#{@staff_appraisal.e2g2_total if @curr_user.userable_id == @staff_appraisal.eval2_by}/ 30 x 25 = #{@view.number_with_precision(@staff_appraisal.e2g2_percent, precision: 2, locale: "en") if @curr_user.userable_id == @staff_appraisal.eval2_by}"]]
...
def bahagian4_3
  ...
  data1 = [["", "KRITERIA ", "PPP", "PPK"],
       ...
       data2 = [["", "KRITERIA (Dinilai berasaskan SKT)", "PPP", "PPK"],
                 ...
                 ["","Kebolehan menyampaikan maksud, pendapat, kefahaman atau arahan secara lisan dan tulisan berkaitan dengan bidang tugas merangkumi penguasaan bahasa melalui tulisan dan lisan dengan menggunakan tatabahasa dan persembahan yang baik","#{@staff_appraisal.e1g2q3}","#{@staff_appraisal.e2g2q3 if @curr_user.userable_id == @staff_appraisal.eval2_by}"],
                 ["", "Jumlah markah mengikut wajaran","#{@staff_appraisal.e1g2_total} / 30 x 25 = #{@view.number_with_precision(@staff_appraisal.e1g2_percent, precision: 2, locale: "en")}",
                   "#{@staff_appraisal.e2g2_total if @curr_user.userable_id == @staff_appraisal.eval2_by} / 30 x 25 = #{@view.number_with_precision(@staff_appraisal.e2g2_percent, precision: 2, locale: "en") if @curr_user.userable_id == @staff_appraisal.eval2_by}"]]
...
def bahagian4_5
  ...
  data1 = [["", "KRITERIA ", "PPP", "PPK"],
           ...
           ["","Keupayaan dan kebolehan menggembleng segala sumber dalam kawalannya seperti kewangan, tenaga manusia,peralatan dan maklumat bagi merancang mengatur, membahagi dan mengendalikan sesuatu tugas untuk mencapai objektif organisasi.", "#{@staff_appraisal.e1g2q1}" , "#{@staff_appraisal.e2g2q1 if @curr_user.userable_id == @staff_appraisal.eval2_by}" ],
             ["2. ","  DISIPLIN", "",""],
             ["","Mempunyai daya kawalan diri dari segi mental dan fizikal termasuk mematuhi peraturan, menepati masa, menunaikan janji dan bersifat sabar.", "#{@staff_appraisal.e1g2q2}","#{@staff_appraisal.e2g2q2 if @curr_user.userable_id == @staff_appraisal.eval2_by}"],
             ["3. ","  PROAKTIF DAN INOVATIF","",""],
             ["","Kebolehan menjangka kemungkinan, mencipta dan mengeluarkan idea baru serta membuat pembaharuan bagi mempertingkatkan kualiti dan produktiviti organisasi.","#{@staff_appraisal.e1g2q3}","#{@staff_appraisal.e2g2q3 if @curr_user.userable_id == @staff_appraisal.eval2_by}"]]
               ...
               ["","Kebolehan pegawai dalam mewujudkan suasana kerjasama yang harmoni dan mesra serta boleh menyesuaikan diri dalam semua keadaan.","#{@staff_appraisal.e1g2q4}","#{@staff_appraisal.e2g2q4 if @curr_user.userable_id == @staff_appraisal.eval2_by}"],
               ["", "Jumlah markah mengikut wajaran","#{@staff_appraisal.e1g2_total} / 30 x 25 = #{@view.number_with_precision(@staff_appraisal.e1g2_percent, precision: 2, locale: "en")} ",
                 "#{@staff_appraisal.e2g2_total if @curr_user.userable_id == @staff_appraisal.eval2_by} / 30 x 25 = #{@view.number_with_precision(@staff_appraisal.e2g2_percent, precision: 2, locale: "en") if @curr_user.userable_id == @staff_appraisal.eval2_by}"]]
...
def bahagian5_4
  ...
  data1 = [["", "KRITERIA (Dinilai berasaskan SKT)", "PPP", "PPK"],
           ["1.", "  KEBOLEHAN MENGELOLA", "", ""],
           ["","Keupayaan dan kebolehan menggembleng segala sumber dalam kawalannya seperti kewangan, tenaga manusia, peralatan dan maklumat bagi merancang mengatur, membahagi dan mengendalikan sesuatu tugas untuk mencapai objektif organisasi.", "#{@staff_appraisal.e1g3q1}" , "#{@staff_appraisal.e2g3q1 if @curr_user.userable_id == @staff_appraisal.eval2_by}" ],
             ["2. ","   DISIPLIN", "",""],
             ["","Mempunyai daya kawalan diri dari segi mental dan fizikal termasuk mematuhi peraturan, menepati masa, menunaikan janji dan bersifat sabar.", "#{@staff_appraisal.e1g3q2}","#{@staff_appraisal.e2g3q2 if @curr_user.userable_id == @staff_appraisal.eval2_by}"],
             ["3. ","   PROAKTIF DAN INOVATIF","",""],
             ["","Kebolehan menjangka kemungkinan, mencipta dan mengeluarkan idea baru serta membuat pembaharuan bagi mempertingkatkan kualiti dan produktiviti organisasi.","#{@staff_appraisal.e1g3q3}","#{@staff_appraisal.e2g3q3 if @curr_user.userable_id == @staff_appraisal.eval2_by}"],
             ["4. ","   JALINAN HUBUNGAN DAN KERJASAMA","",""],
             [""," Kebolehan pegawai dalam mewujudkan suasana kerjasama yang harmoni dan mesra serta boleh menyesuaikan diri dalam semua keadaan.","#{@staff_appraisal.e1g3q4}","#{@staff_appraisal.e2g3q4 if @curr_user.userable_id == @staff_appraisal.eval2_by}"],
             ["", "Jumlah markah mengikut wajaran","#{@staff_appraisal.e1g3_total} / 50 x 20 = #{@view.number_with_precision(@staff_appraisal.e1g3_percent, precision: 2, locale: "en")}","#{@staff_appraisal.e2g3_total if @curr_user.userable_id == @staff_appraisal.eval2_by} / 50 x 20 = #{@view.number_with_precision(@staff_appraisal.e2g3_percent, precision: 2, locale: "en") if @curr_user.userable_id == @staff_appraisal.eval2_by}"]]
...
def bahagian5_5
  ...
  data1 = [["", "KRITERIA (Dinilai berasaskan SKT)", "PPP", "PPK"],
           ["1.", "  ILMU PENGETAHUAN DAN KEMAHIRAN DALAM BIDANG KERJA", "", ""],
           ["","Mempunyai ilmu pengetahuan dan kemahiran/kepakaran dalam menghasilkan kerja meliputi kebolehan mengenalpasti, menganalisis serta menyelesaikan masalah.", "#{@staff_appraisal.e1g3q1}" , "#{@staff_appraisal.e2g3q1 if @curr_user.userable_id == @staff_appraisal.eval2_by}" ],
             ["2. "," PELAKSANAAN PERATURAN DAN ARAHAN PENTADBIRAN", "",""],
             ["","Kebolehan menghayati dan melaksanakan dasar, peraturan dan arahan pentadbiran berkaitan dengan bidang tugasnya.", "#{@staff_appraisal.e1g3q2}","#{@staff_appraisal.e2g3q2 if @curr_user.userable_id == @staff_appraisal.eval2_by}"],
             ["3. ","KEBERKESANAN KOMUNIKASI","",""],
             ["","Kebolehan menyampaikan maksud, pendapat, kefahaman atau arahan","#{@staff_appraisal.e1g3q3}","#{@staff_appraisal.e2g3q3 if @curr_user.userable_id == @staff_appraisal.eval2_by}"],
             ["", "Jumlah markah mengikut wajaran","#{@staff_appraisal.e1g3_total} / 50 x 20 = #{@view.number_with_precision(@staff_appraisal.e1g3_percent, precision: 2, locale: "en")}","#{@staff_appraisal.e2g3_total if @curr_user.userable_id == @staff_appraisal.eval2_by} / 50 x 20 = #{@view.number_with_precision(@staff_appraisal.e2g3_percent, precision: 2, locale: "en") if @curr_user.userable_id == @staff_appraisal.eval2_by}"]]
...
def bahagian5_3
  ...
  data1 = [["", "KRITERIA (Dinilai berasaskan SKT)", "PPP", "PPK"],
           ...
           [" ", " Mempunyai wawasan, komitmen, kebolehan membuat keputusan, menggerak dan memberi dorongan kepada pegawai ke arah pencapaian objektif organisasi.", "#{@staff_appraisal.e1g3q1 }", "#{@staff_appraisal.e2g3q1 if @curr_user.userable_id == @staff_appraisal.eval2_by}"],
           ["1.", "  KEBOLEHAN MENGELOLA", "", ""],
           ["","Keupayaan dan kebolehan menggembleng segala sumber dalam kawalannya seperti kewangan, tenaga manusia, peralatan dan maklumat bagi merancang mengatur, membahagi dan mengendalikan sesuatu tugas untuk mencapai objektif organisasi.", "#{@staff_appraisal.e1g3q2 }" , "#{@staff_appraisal.e2g3q2 if @curr_user.userable_id == @staff_appraisal.eval2_by}" ],
             ["2. ","   DISIPLIN", "",""],
             ["","Mempunyai daya kawalan diri dari segi mental dan fizikal termasuk mematuhi peraturan, menepati masa, menunaikan janji dan bersifat sabar.", "#{@staff_appraisal.e1g3q3 }","#{@staff_appraisal.e2g3q3 if @curr_user.userable_id == @staff_appraisal.eval2_by}"],
             ["3. ","   PROAKTIF DAN INOVATIF","",""],
             ["","Kebolehan menjangka kemungkinan, mencipta dan mengeluarkan idea baru serta membuat pembaharuan bagi mempertingkatkan kualiti dan produktiviti organisasi.","#{@staff_appraisal.e1g3q4 }","#{@staff_appraisal.e2g3q4 if @curr_user.userable_id == @staff_appraisal.eval2_by}"],
             ["4. ","   JALINAN HUBUNGAN DAN KERJASAMA","",""],
             [""," Kebolehan pegawai dalam mewujudkan suasana kerjasama yang harmoni dan mesra serta boleh menyesuaikan diri dalam semua keadaan.","#{@staff_appraisal.e1g3q5 }","#{@staff_appraisal.e2g3q5 if @curr_user.userable_id == @staff_appraisal.eval2_by}"],
             ["", "Jumlah markah mengikut wajaran","#{@staff_appraisal.e1g3_total } / 50 x 20 = #{@view.number_with_precision(@staff_appraisal.e1g3_percent, precision: 2, locale: "en")}","#{@staff_appraisal.e2g3_total if @curr_user.userable_id == @staff_appraisal.eval2_by} / 50 x 20 = #{@view.number_with_precision(@staff_appraisal.e2g3_percent, precision: 2, locale: "en") if @curr_user.userable_id == @staff_appraisal.eval2_by}"]]
...
def bahagian6
  ...
  data1 = [ ["", " ", "PPP","PPK"],
    [ "", "Peringkat Komuniti / Jabatan / Daerah / Negeri / Negara / Antarabangsa", "#{@staff_appraisal.e1g4 }", "#{@staff_appraisal.e2g3q1 if @curr_user.userable_id == @staff_appraisal.eval2_by}"],
             ["","Jumlah markah mengikut wajaran","#{@staff_appraisal.e1g4} / 10 x 5 = #{(@staff_appraisal.e1g4_percent)}",
               "#{@staff_appraisal.e2g4 if @curr_user.userable_id == @staff_appraisal.eval2_by} / 10 x 5 = #{(@staff_appraisal.e2g4_percent) if @curr_user.userable_id == @staff_appraisal.eval2_by}"]]
...
def bahagian7
  ...
  data1 = [[ "", "PPP(%)", "PPK(%)", "MARKAH PURATA (%) 
    untuk diisi oleh Urus Setia PPSM)"],
             ["MARKAH KESELURUHAN",
               "#{@view.number_with_precision(@staff_appraisal.e1_total, precision: 2, locale: "en")}","#{@view.number_with_precision(@staff_appraisal.e2_total, precision: 2, locale: "en") if @curr_user.userable_id == @staff_appraisal.eval2_by}", ""]] 
