class InstructorevaluationPdf < Prawn::Document  
  ...
  def table_main
    ...
    data << [{content: "1", colspan: 2},{content: "#{I18n.t('instructor_appraisal.q1')}", colspan: 2},"#{@appraisal.q1.to_i==2 ? '<b>2</b>' : '2'}","#{@appraisal.q1.to_i==1 ? '<b>1</b>' : '1'}","#{@appraisal.q1.to_i==0 ? '<b>0</b>' : 0}"]
