class Student_listPdf < Prawn::Document 
  def initialize(students, view, college)
  ...
  def line_item_rows
    ...
    counter = counter || 0
    header =[ ["", "#{I18n.t('student.students.icno')}", "#{I18n.t('student.students.name')}", "#{@college.code=='amsas'? I18n.t('student.students.apmmno') : I18n.t('student.students.matrixno')}", "#{I18n.t('student.students.rank_id')}","#{I18n.t('student.students.department')}", "#{I18n.t('student.students.ssponsor')}", "Status", "#{I18n.t('student.students.status_remark')}", "#{I18n.t('student.students.gender')}", "#{I18n.t('student.students.race')}", "#{I18n.t('student.students.mrtlstatuscd')}", "#{I18n.t('student.students.stelno')}", "#{I18n.t('student.students.semail')}"]]
