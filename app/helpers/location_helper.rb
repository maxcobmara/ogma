module LocationHelper
  ...
  def set_view_class_old(location)
  ...
  def set_view_class(location_class)
    case
    when [1,4].include?(location_class)
      content_tag :div, "" , class: "col-md-5 building"
    when location_class == 2
      content_tag :div, "", class: "col-md-7 floor"
    when location_class == 3
      content_tag :div, "", class: "room"
    end
  end
