...
#     end
 ...
 #Group Library   -------------------------------------------------------------------------------
  ...
  role :travel_requests_module_admin do
    has_permission_on :staff_travel_requests, :to => [:manage, :travel_log_index, :travel_log, :approval, :status_movement, :travelrequest_list]
  end                                                                                                                                                     # Admin - can do everything (restrictions: own recs only)
  role :travel_requests_module_viewer do
    has_permission_on :staff_travel_requests, :to => [:read, :travel_log_index, :status_movement, :travelrequest_list] 
  end                                                                                                                                                     # Viewer - can view everything (restrictions : own recs only)
  role :travel_requests_module_user do
    has_permission_on :staff_travel_requests, :to => [:approve, :approval, :travel_log, :travel_log_index, :status_movement, :travelrequest_list] # NOTE - approve : Read+Update
