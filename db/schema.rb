...
ActiveRecord::Schema.define(version: 20171111115637) do
  ...
  create_table "average_courses", force: true do |t|
    ...
    t.text     "dissatisfaction"
    t.text     "recommend_for_improvement"
